...
export const Field = forwardRef<TextInput, ValidatableField<FieldProps>>(
  function Field(
    {
      contRef,
      masks,
    ...
    return (
      <FView ref={contRef} self="stretch" style={contStyle}>
...
export const EmailField = forwardRef<TextInput, ValidatableField<FieldProps>>(
...
export const NameField = forwardRef<TextInput, ValidatableField<FieldProps>>(
...
export const NumberField = forwardRef<TextInput, ValidatableField<FieldProps>>(
...
export const DateField = forwardRef<TextInput, ValidatableField<FieldProps>>(
  function DateField(_, ref) {
...
export const PhoneField = forwardRef<
  TextInput,
  ValidatableField<PhoneFieldProps>
>(function PhoneField({prefix, ...rest}, ref) {
...
const SinglePin = forwardRef<TextInput, ValidatableField<FieldProps>>(
...
export const PinField = forwardRef<TextInput, ValidatableField<PinFieldProps>>(
  function PinField(
    {onValid, length = 6, ...rest}: ValidatableField<PinFieldProps>,
    ref,
  ) {
